    ...
    moments: [
      {
        ...
        description: 'O momento em que tudo mudou. Um beijo que virou o começo de uma história linda.',
        emoji: '💋',
        highlight: true,
      ...
      },
      {
        ...
        description: 'Conversas até tarde, risadas e a certeza de que queria você por perto.',
        emoji: '✨',
        photo: '',
      },
      {
        ...
        description: 'O dia em que disse sim e o coração acelerou de um jeito diferente.',
        emoji: '💍',
        highlight: true,
        photo: '',
      },
  ...
  '2024': {
    ...
    moments: [
      ...
      },
      {
        ...
        description: 'Um ano inteiro de amor, cumplicidade e crescimento juntos. Que venham muitos mais.',
        emoji: '🥳',
        highlight: true,
        photo: '',
      },
  ...
  '2025': {
    ...
    moments: [
      ...
      },
      {
        ...
        description: 'Dois anos juntos. Dois anos de sorrisos, abraços e amor de verdade.',
        emoji: '🎊',
        highlight: true,
        photo: '',
      },
